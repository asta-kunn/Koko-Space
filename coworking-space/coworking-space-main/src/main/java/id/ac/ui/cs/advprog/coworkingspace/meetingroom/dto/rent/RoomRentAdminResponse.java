...
@AllArgsConstructor
@NoArgsConstructor
public class RoomRentAdminResponse {
    ...
    public static RoomRentAdminResponse fromRoomRent(RoomRent roomRent, List<AttendeeStatus> attendeeStatus) {
        return RoomRentAdminResponse.builder()
                .userId(roomRent.getUserId())
